...
func SpatialFrame(jsonld string) []SpatialFrameRes {
	...
	// this is wrong here..   the struct is not aligned to our JSON-LD frame output
...
func parseSpatialCoverage(spatialCvgJson jql.Json) (SpatialCoverage, error) {
	...
	// Is this something I added to ensure a "subject of" for tile38?
	// If so it's a construct that I should not have
