...
function visitClass(config, moduleFile, diagnostics, classNode) {
    ...
    moduleFile.cmpMeta = __assign$1({}, cmpMeta, { componentClass: classNode.name.getText().trim(), membersMeta: __assign$1({}, getElementDecoratorMeta(classNode), getMethodDecoratorMeta(classNode), getStateDecoratorMeta(classNode), getPropDecoratorMeta(moduleFile.tsFilePath, diagnostics, classNode)), eventsMeta: getEventDecoratorMeta(moduleFile.tsFilePath, diagnostics, classNode), listenersMeta: getListenDecoratorMeta(moduleFile.tsFilePath, diagnostics, classNode) }, getPropChangeDecoratorMeta(classNode));
