...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src___ = __webpack_require__(5);


// import data from './example.json';

Object(__WEBPACK_IMPORTED_MODULE_1__src___["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0_d3___default.a);

// var x = JSON.parse(document.getElementById('test').textContent)
var x = JSON.parse(document.querySelectorAll('[type="application/ld+json"]')[0].textContent)

__WEBPACK_IMPORTED_MODULE_0_d3___default.a.jsonldVis(x, '#graph', {
  w: 800,
  h: 600,
  maxLabelWidth: 250,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_tip__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_tip___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_d3_tip__);


/* harmony default export */ __webpack_exports__["a"] = (function(d3) {
  // browserify
  if (!d3.tip) {
    __webpack_require__(1)(d3);
  }
  // webpack
  if (!d3.tip) {
    d3.tip = __WEBPACK_IMPORTED_MODULE_0_d3_tip___default.a;
  }
...
// imports
exports.push([module.i, "@import url(http://fonts.googleapis.com/css?family=Open+Sans:300,400,600);", ""]);
